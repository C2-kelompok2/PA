    ...
    <div class="container">
        <div class="navbar-header">
               ...
               <a class="navbar-brand home" href="index.php" data-animate-hover="bounce">
                    <img src="logoresto.png" class="hidden-xs">
                    <img src="logoresto.png" class="visible-xs"><span class="sr-only">C2 - go to homepage</span>
                </a>
                    ...
                    <div class="box">
                        <form method="post">
                            ...
                            <div class="box-footer">
                                <div class="pull-left">
                                    <a href="all-menu.php" class="btn btn-default"><i class="fa fa-chevron-left"></i> Lanjutkan Belanja</a>
                                </div>
                                <div class="pull-right">
                                    <button type="submit" class="btn btn-primary" name="checkout">Proses Pesanan <i class="fa fa-chevron-right"></i>
                                    </button>
                                    <?php 
