...
// Fungsi untuk menghasilkan kode unik untuk setiap akun kasir yang baru didaftarkan
...
if(isset($_POST['submit'])) {
    ...
    $query = "INSERT INTO kasir (username, password, nama_lengkap, email_kasir, telepon_kasir) 
    ...
    if ($conn->query($query) === TRUE) {
        echo "<script>alert('Akun kasir berhasil dibuat!');</script>";
    } else {
        echo "<script>alert('Terjadi kesalahan saat membuat akun kasir. Silakan coba lagi nanti.');</script>";
    }
