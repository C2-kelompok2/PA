    ...
    <div class="container">
        <div class="navbar-header">
                ...
                <img src="logoresto.png" class="hidden-xs"style="width :100px;">
                    <img src="logoresto.png" class="visible-xs"style="width :100px;"><span class="sr-only">C2 - Restaurant</span>
                </a>
            ...
            <div class="container">
                ...
                <div class="col-md-13">
                    <div class="box" id="contact">
                        ...
                        <p class="lead">For complaints and suggestions, please contact us via the following contacts:</p>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                ...
                                <p class="text-muted">For a fast response, please call the following number.</p>
                            ...
                            <div class="col-sm-4">
                                ...
                                <p class="text-muted">Use email to provide suggestions and complaints.</p>
                                <ul>
                                    <li><strong><a href="mailto:">C2Restaurant@gmail.com</a></strong>
                                    </li>
                                </ul>
                            </div>
                            <!-- /.col-sm-4 -->
