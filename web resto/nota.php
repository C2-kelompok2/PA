...
<body>
    ...
    <div class="container">
        <div class="navbar-header">
                ...
                <a class="navbar-brand home" href="index.php" data-animate-hover="bounce">
                    ...
                    <img src="" class="visible-xs"><span class="sr-only">C2 - Restaurant</span>
                </a>
            ...
            <div class="container">
                ...
                <div class="col-md-13" style="margin-top: 5px;" id="nota">
                    <div class="box" id="contact">
                        <h1>Purchase Orders #<?php echo $_GET['id']; ?></h1>
                        <p class="lead">Here's your purchase receipt:</p>
                        <div class="table-responsive">
                            <table class="table table-bordered">
                                ...
                                <tfoot>
                                    ...
                                    ?>
                                    <tr>
                                        <th colspan="5" class="text-right">Purchase Amount </th>
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <h3><i class="fa fa-file"></i> Purchase Orders</h3>
                                <p><b>No.Orders : <?php echo $data2['id_pembelian']; ?></b>
                                    <br>Date : <?php echo $data2['tanggal_pembelian']; ?>
                            ...
                            <!-- /.col-sm-4 -->
                            <div class="col-sm-4">
                                <h3><i class="fa fa-road"></i> Delivery</h3>
                                <p><b> <?php echo $_SESSION['login']['alamat_pelanggan']; ?></b>
                                    <br>Shipping Cost : Rp.<?php echo $data2['ongkir']; ?>
                                </p>
                            </div>
                            <!-- /.col-sm-4 -->
                        </div>
 ...
 <div id="copyright">
    <div class="container">
        <div class="col-md-6">
            <p class="pull-left">©Copyright - Restoran C2</p>
        </div>
        <div class="col-md-6">
