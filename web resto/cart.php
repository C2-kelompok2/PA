                        ...
                        <form method="post">
                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <?php foreach ($_SESSION["keranjang"] as $id_produk => $jumlah): ?>
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="hapuskeranjang.php?id=<?php echo $id_produk ?>"><i class="fa fa-trash-o"></i>Delete</a>
                                                </td>
                                            </tr>
                                            <?php $total+=$subharga; ?>
                                        <?php endforeach ?>
                                    ...
                                    <tfoot>
                                        <tr>
                                            <th colspan="4">Purchase totals: </th>
                            ...
                            <div class="box-footer">
                                <div class="pull-left">
                                    <a href="all-menu.php" class="btn btn-default"><i class="fa fa-chevron-left"></i> Continue Ordered</a>
                                </div>
                                <div class="pull-right">
                                    <button type="submit" class="btn btn-primary" name="checkout">Processing Ordered <i class="fa fa-chevron-right"></i>
                                    </button>
                                    <?php 
