        ...
        <div class="same-height-row">
            ...
            <div class="col-sm-4">
                <div class="box same-height">
                    ...
                    <h3>About us</h3>
                    <p>Aplikasi ini di khususkan untuk informasi delivery makanan di kawasan.</p>
                </div>
            </div>
            ...
            <div class="col-sm-4">
                <div class="box same-height">
                    ...
                    <h3>Info</h3>
                    <p>Aplikasi ini akan memberikan informasi lengkap mengenai menu makanan di warung-warung area</p>
                </div>
            </div>
        </div>
        <!-- /.row -->
...
<div class="box text-center" data-animate="fadeInUp">
    <div class="container">
        <div class="col-md-12">
            <h3 class="text-uppercase"> C2 bekerja sama dengan banyak warung,Contohnya seperti warnus. </h3>
