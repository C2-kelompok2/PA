		...
		<div class="container-login100">
			<div class="wrap-login100">
				...
				if (isset($_POST['submit'])) {
					...
					$query=$conn->query("SELECT * FROM karyawan WHERE username='$_POST[username]' AND password='$password'");
					$result=$query->num_rows;
					if ($result==1) {
						session_start();
						$_SESSION['karyawan']=$query->fetch_assoc();
						echo "<br>";
						echo "<div class='alert alert-info'><center>Login Berhasil</center></div>";
