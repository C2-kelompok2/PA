        ...
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand home" href="index.php" data-animate-hover="bounce">
                    ...
                    <img src="logoresto.png" class="visible-xs"style="width :100px;"><span class="sr-only">E-Del - go to homepage</span>
                </a>
                ...
                <div class="col-md-3">
                    ...
                    <div class="panel panel-default sidebar-menu">
                        <div class="panel-heading">
                            <h3 class="panel-title">Daftar Cabang Resto C2</h3>
                        </div>
                            ...
                            <div class="col-md-4 col-sm-6">
                                <div class="product">
                                    ...
                                    <div class="text">
                                        ...
                                        <p class="buttons">
                                            <a href="detail_produk.php?id=<?php echo $data3['id_produk']; ?>" class="btn btn-default">Lihat Detail</a>
                                            <a href="buy.php?id=<?php echo $data3['id_produk']; ?>" class="btn btn-primary"><i class="fa fa-shopping-cart"></i>Tambahkan ke Keranjang</a>
                                        </p>
                                    </div>
                                    <!-- /.text -->
                                </div>
